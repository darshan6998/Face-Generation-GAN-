...
Original file is located at
    https://colab.research.google.com/drive/1EtYk5apskRxu4mB47jC-Kn2Pq1I8AaAh
...
**Answer:**
There are more white faces because of the biased database. Output Faces are blurry and distorted which means it lacks more accurate features of the facial structure. To get the proper and accurate output we should add more ethinicity to the datasets. We should try to add more face images having similar angle and Cropping aspect should proper not too zoomed and not too zoomed in. According to the graph the model is not converged so need to add more number of Epochs to get the convergence and accuracy. We should add more number of hidden layers and dimensions would also provide us with the higher accuracy. Having an adaptive learning rate would be more useful than using constant learning rate.
